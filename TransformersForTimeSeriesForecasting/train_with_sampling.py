...
def transformer(dataloader, dataset: MachineDataset, EPOCH, k, path_to_save_model, path_to_save_loss, path_to_save_predictions, device):
    ...
    for epoch in range(EPOCH + 1):
        ...
        if epoch % 10 == 0: # Plot 1-Step Predictions
            ...
            # TODO: plot
            plot_training_3(epoch, path_to_save_predictions, src_humidity, sampled_src_humidity, prediction_humidity, sensor_number, *dataset.get_datetime_labels(index_in.tolist()[0], index_tar.tolist()[0]))
